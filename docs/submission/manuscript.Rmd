...
\noindent
**Figure 1.** **Description of the original meta-analyses.** Diagram outlining the shared and unique inclusion criteria, dependent variable selection, the number of studies screened, and the number of studies included in each meta-analysis.
